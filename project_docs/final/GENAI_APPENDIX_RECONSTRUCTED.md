...
- `Reconstructed prompt:`  
  `We want our A* final project to feel more like an algorithms project and less like just a game demo. Help us narrow it into a clearer question involving heuristics, correctness, and measurable performance.`
...
- `Reconstructed prompt:`  
  `For an interactive A* visualizer, what comparison setup and metrics would make the project analytically meaningful? We want something simple enough for a class project but still rigorous enough to discuss in our report and presentation.`
...
- `Reconstructed prompt:`  
  `Help us organize pseudocode and a final report for an A* visualizer project. We want to explain the algorithm clearly, describe the methodology and testing, and avoid turning the report into just a walkthrough of the code.`
