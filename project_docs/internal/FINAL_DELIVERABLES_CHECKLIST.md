...
- `Code`
  - local Pygame version in `pygame_app/`
...
- Do not say the browser custom mode writes to `project_data/metrics_log.csv`.
...
- Source code:
  - `pygame_app/`, `index.html`, `game.html`, `src/`
- Report:
